...
const koScreens: Record<string, LocalizedScreen> = {
  ...
  'ONB-02': {
    shortTitle: '약속',
    eyebrow: '90일 약속',
    title: '노래는 작은 복귀로 만들어집니다.',
    body: 'VoiceFix는 90일 훈련 여정입니다. 한 세션에서 재능을 증명하는 것이 아니라, 돌아와서 정직하게 녹음하고, 작은 한 가지를 고치고, 내일 다시 오는 방식입니다.',
    primaryAction: '3개월 여정 시작',
    bullets: ['고정된 12주 경로', '월 1회 유예일', '매 세션 한 번의 재시도'],
  },
  'ONB-03': {
    shortTitle: '노래방 아님',
    eyebrow: '다른 연습 루프',
  ...
  'ONB-27': {
    ...
    body: '매일의 목소리 습관은 같은 시간에 같은 작은 약속을 요청할 때 가장 잘 이어집니다.',
