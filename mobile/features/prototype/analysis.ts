...
const feedbackText: Record<MainAppLanguage, {
  ...
  en: {
    ...
    usefulInterpretation: 'That gives VoiceFix enough material to compare one small change.',
  ...
  es: {
    ...
    usefulInterpretation: 'VoiceFix tiene material suficiente para comparar un cambio pequeño.',
  ...
  pt: {
    ...
    usefulInterpretation: 'O VoiceFix tem material suficiente para comparar uma pequena mudança.',
  ...
  fr: {
    ...
    usefulInterpretation: 'VoiceFix a assez de matière pour comparer un petit changement.',
  ...
  de: {
    ...
    usefulInterpretation: 'VoiceFix hat genug Material, um eine kleine Änderung zu vergleichen.',
  ...
  ja: {
    ...
    usefulInterpretation: 'VoiceFix が小さな変化を比べるには十分な材料です。',
  ...
  ko: {
    ...
    usefulInterpretation: 'VoiceFix가 한 가지 변화를 비교하기에 충분한 자료입니다.',
  ...
  zhHans: {
    ...
    usefulInterpretation: 'VoiceFix 有足够材料来比较一个小变化。',
  ...
  zhHant: {
    ...
    usefulInterpretation: 'VoiceFix 有足夠材料來比較一個小變化。',
  ...
  hi: {
    ...
    usefulInterpretation: 'VoiceFix के पास एक छोटे बदलाव की तुलना के लिए पर्याप्त सामग्री है.',
  ...
  ar: {
    ...
    usefulInterpretation: 'لدى VoiceFix مادة كافية لمقارنة تغيير صغير واحد.',
  ...
  id: {
    ...
    usefulInterpretation: 'VoiceFix punya cukup bahan untuk membandingkan satu perubahan kecil.',
